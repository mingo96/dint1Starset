package com.example.starsetapp.vessels
 ...
 *
 *
 * This composable was generated from the UI Package 'vessels'.
 * Generated code; do not edit directly
 */

@Composable
fun Vessels(modifier: Modifier = Modifier, navController: NavController) {
    TopLevel(modifier = modifier) {
        PantallaBasicaInstance(modifier = Modifier
            .rowWeight(1.0f)
            .columnWeight(1.0f),navController)
        Column(Modifier.fillMaxSize()){
            FrameAlbumInstance(modifier = Modifier, album = Album.Vessels)

            InfoAlbum(modifier = Modifier,Album.Vessels)
            CancionEstrella(modifier = Modifier,Album.Vessels)
            ...
            ContenedorCarruselCancionesBasico() {
                CarruselInstance(tipo = Tipo.CancionesVessels)
            }
